      ...
      <PagedText text={text}>
        {sniffed != null && (
          <Banner color="info" className="mb-3">
            {t("largeValue.cannotPreview", { label: sniffed.label })}
          </Banner>
        )}
      </PagedText>
    );
    ...
    return (
      <PagedText text={text}>
        <Banner color="danger" className="mb-3">
          {t("largeValue.decodeFailed", { label: sniffed.label, error: decoded.error })}
        </Banner>
      </PagedText>
    );
  }
  ...
  return (
    <div className="h-full grid grid-rows-[auto_minmax(0,1fr)_auto] gap-3">
      ...
      <HStack space={2} alignItems="center" className="text-sm text-text-subtle">
        <span>
          {t("largeValue.charactersOf", {
            shown: (to - from).toLocaleString(),
        ...
        {pages > 1 && (
          <HStack space={2} alignItems="center" className="ml-auto">
            ...
            <span>
              {t("largeValue.pageOf", { current: page + 1, total: pages.toLocaleString() })}
            </span>
            <Button
              size="xs"
              variant="border"
  ...
  showDialog({
    ...
    title: (
      <HStack space={3} alignItems="center">
        <span>
          {i18n.t("largeValue.typeSize", {
            label: sniffed == null ? i18n.t("largeValue.hiddenValue") : sniffed.label,
