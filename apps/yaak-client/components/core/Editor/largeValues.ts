...
class LargeValueWidget extends WidgetType {
  ...
  toDOM(view: EditorView) {
    ...
    label.textContent =
      this.sniffed == null
        ? i18n.t("largeValue.hiddenSize", { size: formatSize(length) })
        : i18n.t("largeValue.typeSize", {
            label: this.sniffed.label,
    ...
    makeTagButton(
      el,
      this.sniffed == null
        ? i18n.t("largeValue.valueActions")
        : i18n.t("largeValue.typeActions", { label: this.sniffed.label }),
